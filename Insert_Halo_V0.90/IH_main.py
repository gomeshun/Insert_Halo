...
class Insert_Halo():
    ...
    def run_insert_halo(self, zlens = 0.5, zsource = 2.0, DM_type = "CDM", sigma_0 = 20, vel_scale = 25, Mhost = 13, geometry_shape = 
                       "DOUBLE_CONE", shmfplindex = -1.9, msub_min = 6, msub_max = 10, sigma_sub = 0.025, cone_angle_arcsec = 6.0, idle_run = False, 
                       ...
                       reset_data = False, einasto_alpha = 0.678, einasto_r2 = None, sigmalogc = 0.128, gdecom_P = 8, ngaussian = 15,
                       formation_mass_fraction = 0.5, precomputed_host = None):
        ...
        if geometry_shape == "CYLINDER":
            raise SettingsException("The CYLINDER geometry shape should not be used as this returns problematic field halo spatial positions.")
        ...
        IHB = Insert_halo_base(zlens = zlens, zsource = zsource, DM_type = DM_type, sigma_0 = sigma_0,
                              ...
                              gdecom_P = gdecom_P, ngaussian = ngaussian, formation_mass_fraction = formation_mass_fraction,
                              precomputed_host = precomputed_host)
