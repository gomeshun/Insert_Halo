...
class Insert_Halo():
    ...
    def run_insert_halo(self, zlens = 0.5, zsource = 2.0, DM_type = "CDM", sigma_0 = 20, vel_scale = 25, Mhost = 13, geometry_shape = 
                       ...
                       reset_data = False, einasto_alpha = 0.678, einasto_r2 = 199):
        ...
        Current version: 0.20
            -Added code to convert Sashimi subhalo data into appropriate 
            subhalo data for pyHalo
            -Added overarching Insert_Halo class which now contains the 
            run_insert_halo function and added a rerun_insert_halo 
            function to rerun the program after running it once and 
            using the Sashimi data of the first run for subsequent runs
        ...
        IHB = Insert_halo_base(zlens = zlens, zsource = zsource, DM_type = DM_type, sigma_0 = sigma_0,
                              ...
                              center_x = center_x, center_y = center_y, einasto_alpha = einasto_alpha, einasto_r2 = einasto_r2)
    ...
    def rerun_insert_halo(self, zlens = 0.5, zsource = 2.0, DM_type = "CDM", sigma_0 = 20, vel_scale = 25, Mhost = 13, geometry_shape = 
                       ...
                       sh_beta = 4, sh_tt_th = 1.1, sh_dz = 0.01, sh_N_herm = 20, sh_zmax = 10., sh_N_ma = 500, center_x = 0, center_y = 0,
                       replace_data = True, keep_subhalo_data = False, einasto_alpha = 0.678, einasto_r2 = 199):
